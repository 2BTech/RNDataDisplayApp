    ...
    return (
        <View style={{width: '100%',}}>
            ...
            <ScrollView style={{width: '100%', height: '85%'}} showsVerticalScrollIndicator={false}>
                ...
                <View style={{height: separatorHeight}} />
                <Text style={styles.contentText}>The page displays 2 lists of devices: Connected Devices and Available Devices. The Available Devices list will be cleared on an interval to make sure only available devices are present in the list. To connect to an available device, press on the green + icon on the device widget.</Text>
                <View style={{height: separatorHeight / 2}} />
